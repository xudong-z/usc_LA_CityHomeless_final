...
register_google(key = "AIzaSyD4OtL7l6GcgOu2YCwWZkORNRa-TYbStQg")
getOption("ggmap")
la_map = get_map(location = "Los Angeles", 
                       zoom = 10)
...
ui <- fluidPage(tabsetPanel(
    tabPanel("311 Positivity", 
        titlePanel("LA City Homeless Service Evaluation Tools (311 Response Positivity)"),
        helpText("3-1-1, US non-emergency phone system"),  
        sidebarPanel(
            helpText("Tools to evaluate the 311 response level over Month/SPA"),  
      ...
      # tabPanel("311 Positivity(weekday)", 
      #       titlePanel("LA City Homeless Service Evaluation Tools (311 call)"),  
      #       sidebarPanel(
      ...
      #       ),
      tabPanel("311 Capability",
           titlePanel("LA City Homeless Service Evaluation Tools (311 Dealing Capability)"),
           helpText("3-1-1, US non-emergency phone system"), 
            sidebarPanel(
      ...
      tabPanel("311Call Grading",
              titlePanel("LA City Homeless Service Evaluation Tools (311 call grading board)"), 
              helpText("3-1-1, US non-emergency phone system"), 
              sidebarPanel(
    ...
    tabPanel("Shelters' Distribution",
             titlePanel("LA City Homeless Service Evaluation Tools (Shelter)"),  
    ...
    #add from Jue
    tabPanel("Crime(type)",
             titlePanel("LA City Homeless Service Evaluation Tools (crime)"),               
             sidebarPanel(
             ...
             mainPanel(
               verticalLayout(
                 h4("Crime Type in LA", align = "center"),
    ...
    tabPanel("Crime(premise)",
             ...
             mainPanel(
               verticalLayout(
                 h4("Crime Premise in LA", align = "center"),
    ...
    tabPanel("Crime(weapon)",
             ...
             mainPanel(
               verticalLayout(
                 h4("Weapon used in Crime", align = "center"),
    ...
    tabPanel("Crime vs. Shelter",
             titlePanel("LA City Homeless Service Evaluation Tools (crime vs shelter)"),  
             sidebarPanel(
               helpText("Crime Types in Los Angeles"),
               ...
               checkboxGroupInput("show_funs1", "Functions",
                                  names(shelters_fun)[9:27], 
                                  selected = NULL)),
             mainPanel(h4("Crime vs Shelter Distribution", align = "center"),
                 plotOutput(outputId = "crime_shelters"))
             )
